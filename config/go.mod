module github.com/Qualstor/aws-sdk-go-v2/config
...
require (
	...
	github.com/Qualstor/aws-sdk-go-v2/internal/ini v1.3.15
	github.com/Qualstor/aws-sdk-go-v2/service/sso v1.11.11
