...
import (
	...
	"github.com/Qualstor/aws-sdk-go-v2/service/acmpca/types"
...
// CA can fail because of problems such a network outage or back-end Amazon Web
// Services failure or other errors. A failed CA can never return to the pending
// state. You must create a new CA.
//
// * DELETED - Your private CA is within the
