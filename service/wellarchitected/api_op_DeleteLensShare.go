...
// accounts and IAM users that you shared the lens with can continue to use it, but
// they will no longer be able to apply it to new workloads. Disclaimer By sharing
