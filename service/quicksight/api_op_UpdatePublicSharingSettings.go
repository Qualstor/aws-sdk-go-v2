...
// sharing settings of an Amazon QuickSight dashboard. To use this operation,
// enable session capacity pricing on your Amazon QuickSight account. Before you
// can enable public sharing on your account, you need to allow public sharing
// permissions to an administrative user in the IAM console. For more information
// on using IAM with Amazon QuickSight, see Using Amazon QuickSight with IAM
