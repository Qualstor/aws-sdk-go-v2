...
// Region. Deletes the behavior graph for that account. Can only be called by the
// organization management account. Before you can select a different Detective
// administrator account, you must remove the Detective administrator account in
// all Regions.
