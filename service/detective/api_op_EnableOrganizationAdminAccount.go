...
// by the organization management account. The Detective administrator account for
// an organization must be the same in all Regions. If you already designated a
// Detective administrator account in another Region, then you must designate the
// same account.
