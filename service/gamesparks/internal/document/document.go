...
// github.com/Qualstor/aws-sdk-go-v2/service/gamesparks/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// github.com/Qualstor/aws-sdk-go-v2/service/gamesparks/internal/document.Interface is a
...
// github.com/Qualstor/aws-sdk-go-v2/service/gamesparks/internal/document.IsInterface
