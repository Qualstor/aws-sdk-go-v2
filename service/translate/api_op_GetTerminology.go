...
import (
	...
	"github.com/Qualstor/aws-sdk-go-v2/service/translate/types"
...
type GetTerminologyInput struct {
	...
	// this parameter, Amazon Translate returns a file that has the same format as the
	// file that was imported to create the terminology. If you specify this parameter
	// when you retrieve a multi-directional terminology resource, you must specify the
	// same format as that of the input file that was imported to create it. Otherwise,
