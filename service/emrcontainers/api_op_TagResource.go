...
// For example, you can define a set of tags for your Amazon EMR on EKS clusters to
// help you track each cluster's owner and stack level. We recommend that you
// devise a consistent set of tag keys for each resource type. You can then search
