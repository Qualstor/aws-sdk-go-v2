...
// Attaches tags to an existing domain. Tags are a set of case-sensitive key value
// pairs. An domain can have up to 10 tags. See  Tagging Amazon OpenSearch Service
// domains
